...
export default function CartNotification({ isOpen, onClose, productName = '' }) {
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', marginBottom: '16px' }}>
                            ...
                            <div style={{ flex: 1, paddingRight: '20px' }}>
                                ...
                                <p style={{ margin: 0, fontSize: '13px', color: '#6b7280', lineHeight: '1.4' }} title={productName}>
                                    {truncatedName || 'Your item has been added to the cart.'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '10px' }}>
                            <button
                                ...
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.borderColor = '#3B7CF1';
                                    e.currentTarget.style.color = '#3B7CF1';
                                }}
                                onMouseLeave={(e) => {
                            ...
                            <button
                                ...
                                onMouseLeave={(e) => {
                                    e.currentTarget.style.backgroundColor = '#3B7CF1';
                                }}
                            >
